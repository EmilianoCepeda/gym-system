  ...
  await transporter.sendMail({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; background: #0f0f0f; color: #ffffff; padding: 40px;">
        ...
        <h2 style="font-size: 22px; font-weight: 700; margin: 0 0 16px;">Hola, ${safeName}</h2>
        <p style="color: rgba(255,255,255,0.6); line-height: 1.7; margin: 0 0 32px;">
          Gracias por registrarte en Astraeus Gym. Haz clic en el boton de abajo para verificar tu cuenta y comenzar a entrenar.
        </p>
