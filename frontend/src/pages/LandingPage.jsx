    ...
    <div style={{ background: 'var(--bg-base)', color: 'var(--text-primary)', overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <div style={{ width: '26px', height: '26px', background: 'var(--yellow)', clipPath: 'polygon(50% 0%, 100% 100%, 0% 100%)' }} />
          <span style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '20px', letterSpacing: '3px', textTransform: 'uppercase' }}>
            ASTRAEUS GYM
          </span>
        </div>
        <div style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
          {['Nosotros', 'Clases', 'Coaches', 'Contacto'].map(item => (
            <a key={item} href={`#${item.toLowerCase()}`} style={{
              fontFamily: 'var(--font-body)', fontSize: '13px', fontWeight: 500,
              letterSpacing: '2px', textTransform: 'uppercase', color: 'rgba(255,255,255,0.55)',
          ...
          <Link to="/login" style={{
            ...
            padding: '10px 28px', background: 'var(--yellow)', color: '#0f0f0f',
            transition: 'transform 0.2s, box-shadow 0.2s', display: 'inline-block',
          }}
            onMouseEnter={e => { e.target.style.transform = 'scale(1.05)'; e.target.style.boxShadow = '0 0 24px rgba(255,220,0,0.3)' }}
      ...
      <section className="grid-bg" style={{
        ...
        <div className="container" style={{ padding: '0 48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
          <div>
            ...
            <p className="body-text" style={{ maxWidth: '420px', marginBottom: '48px' }}>
      ...
      {/* ── STATS BAR ── */}
      <section style={{ background: 'var(--yellow)', padding: '28px 48px' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px', textAlign: 'center' }}>
          {[
            ...
            <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
              ...
              <p style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: '40px', color: '#0f0f0f', margin: 0, lineHeight: 1, letterSpacing: '-1px' }}>{s.n}</p>
              <p style={{ fontFamily: 'var(--font-body)', fontSize: '11px', fontWeight: 600, color: 'rgba(0,0,0,0.45)', textTransform: 'uppercase', letterSpacing: '3px', margin: 0 }}>{s.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* ── CONTACTO / FOOTER ── */}
      <section id="contacto" style={{ background: 'var(--yellow)', padding: '72px 48px' }}>
        <div className="container">
          ...
          <div style={{ borderTop: '1px solid rgba(0,0,0,0.15)', paddingTop: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
